                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: OutlinedButton.icon(
                            onPressed: handleHowToPlay,
                            icon: const Icon(Icons.school_rounded),
                            label: const Text('操作方法を見る'),
                          ),
                        ),
                        ...
                        const SizedBox(height: 18),
                        const Text(
                          '3つ消すと +0.45秒、1回の消去で 4つ以上消すと +0.9秒。連鎖ほど得点倍率が大きく伸び、FEVER は初回 500pt、以降は 500pt ずつ必要値が増えます。発動すると 7.5 秒間フィーバーです。',
                          style: TextStyle(
                            fontSize: 14,
                            height: 1.5,
